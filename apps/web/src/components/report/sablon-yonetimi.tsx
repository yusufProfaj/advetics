 ...
 * kazancı yok.
 *
 * METRİK SEÇİMİ BU EKRANDA YOK — ve bu kasıtlı. `options` alanı sunucuda
 * saklanıyor ve rapora ulaşıyor, ama BELGE henüz sütunlarını ondan
 * kurmuyor (sabit sütun setleri `report-document.tsx` içinde). Çalışmayan
 * bir seçim kutusu koymak, olmayan bir özellik vaat etmek olurdu.
 */
